<section class="hero">
    <div class="hero-container">
        ...
        <div class="hero-buttons">
            <a href="/live" class="btn btn-primary">🔴 Zum Stream</a>
            <a href="https://discord.gg/KfZRZ4WTnG"
...
<section class="section">
    <div class="container">
        ...
        <div style="text-align:center;margin-top:2rem;">
            <a href="/gallery" class="btn btn-primary">Alle Bilder ansehen</a>
        </div>
    </div>
</section>
...
<section class="section" style="background:rgba(255,48,80,0.02);">
    <div class="container">
        ...
        <div style="text-align:center;margin-top:2rem;">
            <a href="/videos" class="btn btn-primary">Alle Videos ansehen</a>
        </div>
    </div>
</section>
...
<?php require BASE_PATH . '/public/assets/js/home.js'; ?>
